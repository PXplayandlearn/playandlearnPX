...
var update = __webpack_require__(92)("6a275b95", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Auth_auth_js__ = __webpack_require__(1710);
//
//
//
//
    ...
    methods: {
        onSubmit: function onSubmit() {
            if (this.formstate.$invalid) {
                ...
                alert('success');
                __WEBPACK_IMPORTED_MODULE_3__Auth_auth_js__["a" /* default */].register(this, this.first_name, this.last_name, this.email, this.password);
                          ...
                          _c(
                            ...
                            [
                              _c(
                                ...
                                [_vm._v("First Name is a required field")]
                              )
                            ]
                          )
                        ],
...
/* harmony default export */ __webpack_exports__["a"] = ({
    register: function register(context, first_name, last_name, email, password) {
