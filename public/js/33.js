...
var update = __webpack_require__(92)("34bd8917", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0cf18656\",\"scoped\":false,\"hasInlineConfig\":true}!./chartist.css", function() {
     var newContent = require("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0cf18656\",\"scoped\":false,\"hasInlineConfig\":true}!./chartist.css");
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(92)("98982ad0", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0cf18656\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./chartist.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0cf18656\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./chartist.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_v_chartist__ = __webpack_require__(851);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_chartist__ = __webpack_require__(847);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    name: "charts",
    components: {
        VueChartist: __WEBPACK_IMPORTED_MODULE_1_v_chartist___default.a
    },
        ...
        return {
            ...
            series: {
                ...
                options: {
                    ...
                    series: {
                        'series-1': {
                            lineSmooth: __WEBPACK_IMPORTED_MODULE_2_chartist___default.a.Interpolation.step()
                        },
                        'series-2': {
                            lineSmooth: __WEBPACK_IMPORTED_MODULE_2_chartist___default.a.Interpolation.simple(),
                            showArea: true
                        },
                        'series-3': {
                            showPoint: false
                ...
                ['screen and (max-width: 320px)', {
                    series: {
                        'series-1': {
                            lineSmooth: __WEBPACK_IMPORTED_MODULE_2_chartist___default.a.Interpolation.none()
                        },
                        'series-2': {
                            lineSmooth: __WEBPACK_IMPORTED_MODULE_2_chartist___default.a.Interpolation.none(),
                            showArea: false
            ...
            time: {
                data: {
                    ...
                    series: [{
                        name: 'series-1',
                        data: [{ x: new Date(143134652600), y: 53 }, { x: new Date(143234652600), y: 40 }, { x: new Date(143340052600), y: 45 }, { x: new Date(143366652600), y: 40 }, { x: new Date(143410652600), y: 20 }, { x: new Date(143569652600), y: 10 }, { x: new Date(143579652600), y: 1 }]
                    }, {
                        name: 'series-2',
                        data: [{ x: new Date(143134652600), y: 53 }, { x: new Date(143234652600), y: 35 }, { x: new Date(143334652600), y: 30 }, { x: new Date(143384652600), y: 30 }, { x: new Date(143568652600), y: 10 }, { x: new Date(143568652600), y: 5 }, { x: new Date(143568652600), y: 1 }]
                    }]
                },
                options: {
                    fullWidth: true,
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0cf18656", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\components\\pages\\chartist.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0cf18656", Component.options)
  } else {
    hotAPI.reload("data-v-0cf18656", Component.options)
  }
